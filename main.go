...
// mpsS возвращает значение скорости в м/с возведенное в степень 2
func (w Walking) mpsS() float64 {
	return math.Pow(w.meanSpeed()*KmHInMsec, 2)
}

// height возвращает рост в метрах
func (w Walking) height() float64 {
	return w.Height / CmInM
}
...
func (w Walking) Calories() float64 {
	return (CaloriesWeightMultiplier*w.Weight + (w.mpsS()/w.height())*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
}
